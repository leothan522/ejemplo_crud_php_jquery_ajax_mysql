...
CREATE DATABASE IF NOT EXISTS `curso` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `curso`;

-- Volcando estructura para tabla curso.personas
...
-- Volcando datos para la tabla curso.personas: ~0 rows (aproximadamente)
